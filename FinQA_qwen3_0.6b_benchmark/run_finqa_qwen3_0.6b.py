...
class QwenPrompter:
    def __init__(self):
        ...
        self.model = AutoModelForCausalLM.from_pretrained("Qwen/Qwen3-0.6B", trust_remote_code=True, torch_dtype=torch.float16).to(self.device).eval()
...
out_df.to_csv("/home/tienpv16/Documents/Research/project_SML/SML_master_R5/FinQA_qwen3_0.6b_benchmark/results_finqa.csv", index=False)
